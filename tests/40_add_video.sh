...
@test "adds a TV show" {
    ...
    [ "$( media_lookup_atom "$installed" ©ART )" = 'House, Season 1' ]
    [ "$( media_lookup_atom "$installed" ©alb )" = 'House, Season 1' ]
...
@test "works with extended episodes" {
    ...
    [ "$( media_lookup_atom "$installed" ©ART )" = 'Brooklyn Nine-Nine, Season 4' ]
    [ "$( media_lookup_atom "$installed" ©alb )" = 'Brooklyn Nine-Nine, Season 4' ]
    [ "$( media_lookup_atom "$installed" stik )" = 'TV Show' ]
    [ "$( media_lookup_atom "$installed" covr )" = '1 piece of artwork' ]
...
@test "metadata overrides directory name for single video file directories" {
    ...
    [ "$( media_lookup_atom "$installed" ©ART )" = 'Buffy the Vampire Slayer, Season 4' ]
    [ "$( media_lookup_atom "$installed" ©alb )" = 'Buffy the Vampire Slayer, Season 4' ]
